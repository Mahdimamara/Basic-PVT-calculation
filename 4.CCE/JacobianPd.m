function JacP = JacobianPd(P,T,comp,R,Tc,Pc,omegaa,omegab,sigma1,sigma2,K_ij,m,C,Nc,K,Fvd)
...
Dpplus=sum((Kpplus-1).*comp./(1+Fvd*(Kpplus-1)));
Dpmin=sum((Kpmin-1).*comp./(1+Fvd*(Kpmin-1)));
